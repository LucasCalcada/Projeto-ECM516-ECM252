  ...
  return (
    <div className="h-full p-4 transition-colors md:p-8">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        {/* Perfil */}
        <section
          className={`rounded-xl border border-neutral-800 bg-neutral-900/40 p-6 transition-colors lg:col-span-1`}
        >
          ...
          <div className="mb-6 flex flex-col items-center gap-4">
            ...
            <div className="text-center">
              ...
              <p className={`text-sm text-neutral-400`}>{profile.apartment}</p>
            </div>
          </div>
            ...
            <>
              <div className="mb-4 space-y-3">
                <input
                  ...
                  className={`w-full rounded-lg border border-neutral-700 bg-neutral-800 px-3 py-2 text-neutral-100 placeholder-neutral-500 transition focus:border-blue-500 focus:outline-none`}
                />
                <input
                  type="email"
                  value={profile.email}
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className={`flex-1 rounded-lg bg-neutral-700 py-2 font-medium text-white transition hover:bg-neutral-600`}
                >
